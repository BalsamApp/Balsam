...
public class dep_p_editmyinfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pp_edit_myinfo);
    ...
    private void launchActivitmyinfo() {
            ...
            Intent intent = new Intent(this, dep_p_myinfo_activity.class);
    ...
    class BackgroundTaskGet extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(dep_p_editmyinfo.this, "Loading Data", null, true, true);
        ...
        protected void onPostExecute(String httpResponseMsg) {
            ...
            Toast.makeText(dep_p_editmyinfo.this, httpResponseMsg.toString(), Toast.LENGTH_LONG).show();
        }
    ...
    public static String dep_editinformation_patient(int parentsidd, int idd, String name, int phone,String gender,String brithDay,
