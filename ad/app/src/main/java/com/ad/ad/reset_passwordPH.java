...
public class reset_passwordPH extends AppCompatActivity {
    String id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Intent intent = getIntent();
        id = intent.getExtras().getString("pharid");
        setContentView(R.layout.activity_reset_password_ph);
    }
    ...
    class BackgroundWorkerpass extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String login_url = "http://balsam.000webhostapp.com/reset_passPH.php";
            try {
    ...
    public static String reset_Passwoerd_PH(int pharmsistid, int phone, String date){
