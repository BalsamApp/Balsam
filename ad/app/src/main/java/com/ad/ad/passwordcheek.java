...
public class passwordcheek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_passwordcheek);
    ...
    public void pass_check(){
        ...
        BackgroundWorker backgroundWorkerd=new BackgroundWorker(this);
    ...
    class BackgroundWorker extends AsyncTask<String,Void,String> {
        ...
        BackgroundWorker(passwordcheek ctx){
            context=ctx;
        }
        ...
        protected String doInBackground(String... params) {
            ...
            String login_url= "http://balsam.000webhostapp.com/Dpass_check.php";
            try {
                idd=params[0];
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("\"The data is not correct\"")){
                ...
                alertDialog.setMessage(result);
                alertDialog.show();
                Intent myIntent = new Intent(passwordcheek.this, resetPassword.class);
