...
public class password_check extends AppCompatActivity {
    ...
    class BackgroundWorker extends AsyncTask<String,Void,String> {
        ...
        BackgroundWorker(password_check ctx){
            context=ctx;
        }
        ...
        protected String doInBackground(String... params) {
            ...
            String login_url= "http://balsam.000webhostapp.com/pass_check.php";
            try {
                 idd=params[0];
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("\"The data is not correct\"")){
                ...
                alertDialog.setMessage(result);
                alertDialog.show();
                Intent myIntent = new Intent(password_check.this, reset_password.class);
